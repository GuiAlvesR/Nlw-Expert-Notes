...
export function NewNoteCard({ onNoteCreated }: newNoteCardProps) {
    ...
    function handleStartRecording() {
        ...
        const isSpeechRecognitionAPI = window.SpeechRecognition || window.webkitSpeechRecognition

        speechRecognition = new isSpeechRecognitionAPI()
    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 text-left p-5 gap-3 hover:ring-2 hover:ring-slate-600 outline-none focus-visible:ring-2 focus-visible:ring-lime-400">
                ...
                <p className="text-sm leading-6 text-slate-4    00">
